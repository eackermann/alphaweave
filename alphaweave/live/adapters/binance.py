...
class BinanceAdapter(BrokerAdapter):
    ...
    def connect(self) -> None:
        raise NotImplementedError("BinanceAdapter.connect must initialize REST/WebSocket clients")
    ...
    @classmethod
    def from_config(cls, config: BrokerConfig) -> "BinanceAdapter":
        extra = config.extra or {}
        return cls(
            api_key=str(extra["api_key"]),
            api_secret=str(extra["api_secret"]),
            base_url=str(extra.get("base_url", "https://api.binance.com")),
